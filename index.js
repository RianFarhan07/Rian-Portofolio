const projectsDatabase = [
    {
        id: 1,
        title: "Kelompro App",
        description: "Aplikasi Manajemen Kerja Kelompok Mobile Android menggunakan bahasa Kotlin",
        category: "android",
    ...
    },
    {
        ...
        description: "Aplikasi pencatat tamu di dinas ketenagakerjaan kota Makassar",
        category: "android",
    ...
    filterBtns.forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            if (filter === 'all') {
                ...
                const filteredProjects = projectsDatabase.filter(project => project.category === filter);
